...
- **🧯 Parametre Dayanıklılık Haritası:** look-back × top-N Sharpe/CAGR ısı haritası (aşırı-uyum testi) + Dayanıklı/Orta/Kırılgan verdikti · **🧪 Özel Bileşik Oluşturucu:** sleeve'leri aç/kapat → ortak dönemde anlık yeniden hesap (canlı eğri).
